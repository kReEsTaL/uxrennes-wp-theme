...
Utiliser une balise <code>&lt;span&gt;&lt;/span&gt;</code> pour mettre du texte en noir, et une balise <code>&lt;br /&gt;</code> pour forcer un retour à la ligne.',
		...
		array (
			'key' => 'field_56c8d64745f40',
			'label' => 'Sponsors',
			'name' => 'uxr_event_sponsors',
			'type' => 'taxonomy',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
...
acf_add_local_field_group(array (
	...
	'fields' => array (
		...
		array (
			'key' => 'field_56c8d3175fc3a',
			'label' => 'Liens',
			'name' => 'uxr_talk_links',
			'type' => 'repeater',
			'instructions' => 'Lien vers les slides, vers une vidéo, vers un site ou un blog…',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
